...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		...
		m_oi = new OI();
		m_DriveBase.reset();
		m_chooser.setDefaultOption("PurePursuit Test",
				new PursuitDrive(Paths.getStraightPath(), RobotMap.trackWidth + 1, 10));
		m_chooser.addOption("PurePursuit Thread Test",
				new PursuitDriveThread(Paths.getStraightPath(), 10));
		m_chooser.addOption("Six Seconds, Half Power", new TimedDrive(6, .5));
		m_chooser.addOption("Go Forward 25 inches", new autoDrive(25));
		// m_chooser.addOption("Pathfinder Test", new PathDrive(Paths.straightPoints,
		// Paths.configSlow));
	...
	public void robotPeriodic() {
		...
		SmartDashboard.putNumber("Left Velocity", DriveBase.lVelocity);
		SmartDashboard.putNumber("Right Velocity", DriveBase.rVelocity);
	}
